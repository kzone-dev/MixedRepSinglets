...
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=48/2,tmax2=48/2,tp=48,Nmax=10,channel="g5_nonsinglet_FUN",ensemble="M1",header=True)
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g5_nonsinglet_FUN",ensemble="M2")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=96/2,tmax2=96/2,tp=96,Nmax=10,channel="g5_nonsinglet_FUN",ensemble="M3")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g5_nonsinglet_FUN",ensemble="M4")

fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=48/2,tmax2=48/2,tp=48,Nmax=10,channel="g1_nonsinglet_FUN",ensemble="M1",header=True)
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g1_nonsinglet_FUN",ensemble="M2")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=96/2,tmax2=96/2,tp=96,Nmax=10,channel="g1_nonsinglet_FUN",ensemble="M3")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g1_nonsinglet_FUN",ensemble="M4")

fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=48/2,tmax2=48/2,tp=48,Nmax=10,channel="g5_nonsinglet_AS",ensemble="M1",header=True)
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g5_nonsinglet_AS",ensemble="M2")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=96/2,tmax2=96/2,tp=96,Nmax=10,channel="g5_nonsinglet_AS",ensemble="M3")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g5_nonsinglet_AS",ensemble="M4")

fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=48/2,tmax2=48/2,tp=48,Nmax=10,channel="g1_nonsinglet_AS",ensemble="M1",header=True)
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g1_nonsinglet_AS",ensemble="M2")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=96/2,tmax2=96/2,tp=96,Nmax=10,channel="g1_nonsinglet_AS",ensemble="M3")
fit_eigenvalues_file(filename,tmin1=3,tmin2=3,tmax1=64/2,tmax2=64/2,tp=64,Nmax=10,channel="g1_nonsinglet_AS",ensemble="M4")
